...
public class NotWritablePropertyException extends InvalidPropertyException {
	 ...
	 *            suggestions for actual bean property names that closely match the
	...
	/**
	 * Return suggestions for actual bean property names that closely match the
	 * invalid property name, if any.
	 */
